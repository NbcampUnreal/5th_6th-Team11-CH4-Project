...
bool AEquippableWeapon_::CanAttack() const
{
	...
	float MinTimeBetweenAttacks = 1.0f / FireRate;
...
void AEquippableWeapon_::ProcessAttack()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("[Weapon] ProcessAttack() not implemented in child class"));
}
...
void AEquippableWeapon_::Reload()
{
	...
	UE_LOG(LogTemp, Log, TEXT("[Weapon] Reload started"));
}
...
void AEquippableWeapon_::CompleteReload()
{
	...
	UE_LOG(LogTemp, Log, TEXT("[Weapon] Reload completed - Ammo: %d/%d"), CurrentAmmo, MaxAmmo);
}
...
void AEquippableWeapon_::AddAmmo(int32 Amount)
{
	...
	UE_LOG(LogTemp, Log, TEXT("[Weapon] Ammo added: %d (Total: %d/%d)"), Amount, CurrentAmmo, MaxAmmo);
}
...
void AEquippableWeapon_::RefillAmmo()
{
	...
	UE_LOG(LogTemp, Log, TEXT("[Weapon] Ammo refilled: %d/%d"),
		CurrentAmmo, MaxAmmo);
}
...
void AEquippableWeapon_::OnRep_CurrentAmmo()
{
	...
	UE_LOG(LogTemp, Log, TEXT("[Weapon Client] Ammo updated: %d/%d"), CurrentAmmo, MaxAmmo);
}
